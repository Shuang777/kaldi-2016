...
cmvn_type=`cat $alidir/cmvn_type 2>/dev/null`
...
cp $alidir/cmvn_type $dir 2>/dev/null # cmn/cmvn option.
...
case $feat_type in
  ...
  lda) sifeats="ark,s,cs:$cmvn_feats scp:$sdata/JOB/feats.scp ark:- | splice-feats $splice_opts ark:- ark:- | transform-feats $alidir/final.mat ark:- ark:- |"
