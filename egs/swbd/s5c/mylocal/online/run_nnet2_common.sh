...
run
  ...
  n=$[`cat data/train/utt2spk | wc -l` - 4000]
...
run
  ...
  utils/data/remove_dup_utts.sh 200 data/train_scaled_hires_30k data/train_scaled_hires_30k_nodup  # 33hr
  ...
  utils/data/remove_dup_utts.sh 200 data/train_scaled_hires_100k data/train_scaled_hires_100k_nodup;

  utils/data/remove_dup_utts.sh 300 data/train_scaled_hires_nodev data/train_scaled_hires_nodup  # 286hr
  utils/data/remove_dup_utts.sh 300 data/train_hires_nodev data/train_hires_nodup  # 286hr
